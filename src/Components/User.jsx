  ...
  return (
    <>
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800">Database</h1>
        <Link
          to="/create-user"
          className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"
        >
          <i className="fas fa-download fa-sm text-white-50" /><b>+</b> Add user
        </Link>
      </div>
        ...
        <div className="card-header py-3">
          ...
          <div className="card-body">
            {userData.loading ? (
              ...
              <SyncLoader color="#36d7b6" className="text-center" />
            ) : (
